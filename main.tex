...
\begin{figure}[H]
\centering
\includegraphics[width=0.7\textwidth]{visualizations/target_distribution.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{visualizations/sofa_distributions.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{visualizations/advanced_ml_performance.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{visualizations/logistic_regression_feature_importance.png}
